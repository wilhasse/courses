create table part (
    ...
    p_size bigint,
    p_container char(10),
    primary key(p_partkey) USING HASH
) ENGINE='MEMORY';
...
create table supplier(
    ...
    s_region char(20),
    s_phone char(20),
    primary key(s_suppkey) USING HASH
) ENGINE='MEMORY';
...
create table customer(
    ...
    primary key(c_custkey) USING HASH
) ENGINE='MEMORY';
...
create table date(
    ...
    d_holidayfl bigint,
    d_weekdayfl bigint,
    primary key(d_datekey) USING HASH
) ENGINE='MEMORY';
...
create table lineorder (
    ...
    lo_shipmode char(10),
    primary key(lo_orderkey, lo_linenumber) USING HASH
) ENGINE='MEMORY';
